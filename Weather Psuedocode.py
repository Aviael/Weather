...
def this_api():
    ...
    print("Welcome to my attempt at using an API from openweathermap.com. Below you will be prompted for your City or Zip code to get the data from OpenWeatherMap.org.")
